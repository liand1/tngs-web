...
const getLogoWidth = computed(() => {
  if (!unref(getIsMixMode) || unref(getIsMobile)) return {};
...
<template>
  <Header :class="getHeaderClass" class="layout-header">
    <!-- left start -->
    <div :class="`${prefixCls}-left`">
      ...
      <div class="anticon" :class="getAppLogoClass" @click="goHome">
        <img src="@/assets/images/newslogo.png" style="width:198px;"/>
        <div
          v-show="showTitle"
    ...
    <div :class="`${prefixCls}-action`">
      <AppSearch
        v-if="getShowSearch"
        :class="`${prefixCls}-action__item search-item`"
      />

...
export const useUserStore = defineStore('app-user', {
  ...
  getters: {
    ...
    getIsLocal(state): CacheTypeEnum {
  ...
  actions: {
    ...
    setIsLocal(isLocal: CacheTypeEnum) {
    ...
    async login(
      ...
      try {
        ...
        // this.setIsLocal(immediate ? CacheTypeEnum.LOCAL : CacheTypeEnum.SESSION)


        // console.log('immediate--', accessToken)

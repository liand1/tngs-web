...
<template>
  ...
  <Form v-show="getShow" ref="formRef" class="enter-x" :model="formData" :rules="getFormRules"
    @keypress.enter="handleLogin">
    <FormItem name="tenantName" class="enter-x" v-if="false">
    ...
    <FormItem name="username" class="enter-x">
      <Input v-model:value="formData.username" size="large" :placeholder="t('sys.login.userName')"
        class="fix-auto-fill">
      <template #prefix>
        <UserOutlined style="color: rgb(255 115 131 / 100%)" />
      </template>
      </Input>
    </FormItem>
    <FormItem name="password" class="enter-x">
      <InputPassword v-model:value="formData.password" size="large" visibility-toggle
        ...
        <template #prefix>
          <LockOutlined style="color: rgb(255 115 131 / 100%)" />
        </template>
      </InputPassword>
    </FormItem>

...
import SampleConnectedChart from "./samplestatistics/SampleConnectedChart.vue";
import FilterSelects from "./samplestatistics/FilterSelects.vue";
import TimeControls from "./samplestatistics/TimeControls.vue";
import {
  convertToSampleDataItems,
  updateChartData,
} from "./samplestatistics/data";
...
<template>
  <div class="statistics-container" ref="statisticsRef">
    <Card class="statistics-card" :title="'样本统计'">
      <!-- 标题与筛选区域 -->
      <template #extra>
        <!-- 使用新的TimeControls组件 -->
        <TimeControls
          ...
          :date-range="chartDateRangeStrings"
